...
import { Eye, EyeClosed, LoaderCircle, LockKeyhole, Mail, MessagesSquare, User } from "lucide-react";
      ...
      <div className="flex flex-col items-center justify-center p-6 md:p-12 w-full mx-auto min-h-screen">
        ...
        <form
          ...
          <div className="form-control w-full max-w-md">
            ...
            <div className="group flex items-center gap-2 border border-gray-500 rounded-md px-3 py-2 focus-within:border-amber-400 transition-colors duration-200">
              <User
                size={24}
                color="#d18c15"
                strokeWidth={1.75}
      ...
      <div className="flex items-center justify-center w-full bg-gray-900 min-h-screen">
        <div className="flex flex-col items-center justify-center w-full">
          ...
          <div className="flex flex-col items-center justify-center max-w-80 flex-wrap text-center mt-5">
            ...
            <p className="text-xs opacity-50">Connect with friend, share moments and stay in touched with your loved ones.</p>
          </div>
        </div>
      </div>
    </div>
